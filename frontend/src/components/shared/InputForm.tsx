    ...
    <div className="bg-white rounded-2xl shadow-sm border border-slate-200 p-8 mt-4">
      <div className="mb-6">
        ...
        <p className="text-slate-600">
          Enter any topic and we'll automatically create the perfect educational
          video with diagrams and narration
        </p>
      </div>
      ...
      <form onSubmit={onSubmit} className="space-y-3">
        <div>
          ...
          <input
            ...
            placeholder="e.g., Water Cycle, Photosynthesis, Pythagorean Theorem, Cell Division..."
